...
public class FrmVehicle extends javax.swing.JFrame {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        if(pnlview==null){
            pnlview=new PnlVehicleView();
            pnlVehicleController=new PnlVehicleController(pnlview);
        }
        addComponent(pnlview);
    }//GEN-LAST:event_btnViewActionPerformed

    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        int opcion=JOptionPane.showConfirmDialog(null, "¿Desea cerrar el programa?","Confirmacion de cierre",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
