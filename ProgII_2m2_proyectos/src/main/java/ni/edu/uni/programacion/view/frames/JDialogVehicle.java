 ...
 * @author Sistemas-05
 */
public class JDialogVehicle extends javax.swing.JDialog {
     ...
     */
    public JDialogVehicle(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogVehicle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVehicle dialog = new JDialogVehicle(new javax.swing.JFrame(), true);
